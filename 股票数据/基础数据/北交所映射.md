...
- 描述：查询北交所新旧股票代码的映射关系，支持按旧代码 `o_code`（如 `838163.BJ`）或新代码 `n_code`（如 `920163.BJ`）筛选；不传参数时查询全量对照关系。
...
不传参数返回全量映射，共 248 条。以下为前 3 条。

| listing_date | new_code | old_code | stock_name |
|------|------|------|------|
| 2023-05-31 | 920017 | 430017 | 星昊医药 |
| 2020-11-24 | 920047 | 430047 | 诺思兰德 |
| 2021-08-09 | 920090 | 430090 | 同辉信息 |
| ... | ... | ... | ... |
