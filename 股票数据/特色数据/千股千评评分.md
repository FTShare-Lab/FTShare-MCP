...
- 描述：查询单只 A 股在千股千评中的历史综合评分，按诊断日期提供该标的的综合评价。
- 数据范围：最新一期快照
...
CALL_RESPONSE=$(curl -fsS -m 60 -X POST "$MCP_BASE_URL" \
  ...
  -H "Mcp-Session-Id: $SID" \
  -H "MCP-Protocol-Version: 2025-11-25" \
  -d '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"ft_stock_comment_score_em","arguments":{"symbol":"600000"}}}')
...
|------|------|------|
| null | 2026-05-26 | 71.18530696 |
| null | 2026-05-27 | 68.13303852 |
| null | 2026-05-28 | 64.40789014 |
| ... | ... | ... |
