...
- 描述：查询单只 A 股按交易日统计的历史机构参与度。该指标来源于千股千评数据，反映机构资金对标的的参与活跃程度。
- 数据范围：最新一期快照
...
CALL_RESPONSE=$(curl -fsS -m 60 -X POST "$MCP_BASE_URL" \
  ...
  -H "Mcp-Session-Id: $SID" \
  -H "MCP-Protocol-Version: 2025-11-25" \
  -d '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"ft_stock_comment_org_participate_em","arguments":{"symbol":"600000"}}}')
...
|------|------|------|
| null | 2026-05-26 | 0.49109800 |
| null | 2026-05-28 | 0.38572800 |
| null | 2026-05-29 | 0.34089480 |
| ... | ... | ... |
